...
HD_PWD='C:/Arquitect de Computadoras/Cam1-2-Maq-Estados/Cam1-2-Maq-Estados.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Union1y2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Union1y2.tcl
