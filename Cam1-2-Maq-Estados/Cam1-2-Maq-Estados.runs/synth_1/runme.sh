...
HD_PWD='C:/ArquitecturaDeComputadoras/Cam1-2-Maq-Estados/Cam1-2-Maq-Estados.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log un.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source un.tcl
